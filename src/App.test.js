...
it("should pass the placeholder props to the input which is equal to Search",()=>{
  expect(screen.getByTestId('input').getAttribute("placeholder")).toBe("Search");
})

it("should not show alert indicating insufficient input length, when there is no submit",()=>{
